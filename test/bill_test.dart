...
void main(){
  ...
  Bill normalBill = new Bill(UserApp("Jean","+2454564537"),UserApp("Alice","+5552757654"),452,"",date,false);
  Bill billShared = new Bill(UserApp("Jean","+2454564537"),UserApp("Alice","+5552757654"),452,"",date,true);
